...
const fullScreen = player.querySelector('.player__button2')
...
function scrub(e) {
    const scrubTie = (e.offsetX / progress.offsetWidth) * video.duration;
    video.currentTime = scrubTie;
    console.log(e)
}

function handleFullScreen(e) {
    console.log('Hiiiting')
    console.log(e)
}
